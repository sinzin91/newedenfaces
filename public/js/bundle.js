...
var AddCharacterActions = function () {
	function AddCharacterActions() {
		...
		this.generateActions('addCharacterSuccess', 'addChracterFail', 'updateName', 'updateGender', 'invalidName', 'invalidGender');
	}
	...
	_createClass(AddCharacterActions, [{
		...
		value: function addCharacter(name, gender) {
			...
			$.ajax({
				...
				_this.actions.addChracterFail(jqXhr.responseJSON.message);
			});
		}
	}]);
...
var CharacterStore = function () {
  ...
  _createClass(CharacterStore, [{
    ...
    value: function onReportSuccess() {
      ...
      toastr.warning('Character has not been reported.');
    }
  }, {
    key: 'onReportFail',
