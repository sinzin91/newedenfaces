...
app.get('/api/characters', function(req, res, next) {
  ...
  Character.find({ random: { $near: [Math.random(), 0] } })
    ...
    .exec(function(err, characters) {
      ...
      // if less than 2 characters of one gender found
      // get 2 characters of the opposite gender
      ...
      Character
        ...
        .exec(function(err, characters) {
          ...
          // if 2 characters of either gender not found
          // set votedd to false for all characters
...
app.put('/api/characters', function(req, res, next) {
  ...
  if (winner === loser) {
    return res.status(400).send({ message: 'Cannot vote for an against the same character.' });
  }
